...
public class Main {
  public static void main(String[] args) {
    ...
    System.out.println(
        "Total Money is $"
            + String.format("%4.2f", totalValue)
            + " total weight is "
            + String.format("%4.3f", totalWeight)
            + "oz");
    ...
    if (amountNeeded > 0.001f) {
      System.out.println(
          "I don't have enough money. I still owe you $" + String.format("%4.2f", amountNeeded));
    }
